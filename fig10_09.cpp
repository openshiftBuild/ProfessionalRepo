...
#include <stdexcept>
#include "Array.h"
#include <iomanip>//allows you to manipulate output, example setprecision
...
int main() {
    ...
    std::cout << std::setprecision(2);//sets decimal places to 2

    std::cout << std::fixed;//suppresses scientific notations

    Array<double> integers1{7};
